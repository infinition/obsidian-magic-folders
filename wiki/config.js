...
const CONFIG = {
    ...
    projectName: "OBSIDIAN-MAGIC-FOLDERS",
    projectSubtitle: "OBSIDIAN-MAGIC-FOLDERS WIKI",
    description: "Official Documentation and Wiki for obsidian-magic-folders",

    // Versioning Settings
    versioning: {
        type: "local",
        manualVersion: "v1.1.1",
        manualDate: "2026-02-22"
    },

    // GitHub Repository
    repo: "infinition/obsidian-magic-folders",
    branch: "main",
    ...
    // Footer
    footerText: "© 2026 OBSIDIAN-MAGIC-FOLDERS WIKI - All rights reserved",
    ...
    social: {
        discord: null,
        reddit: null,
        github: "https://github.com/infinition/obsidian-magic-folders", // Virgule respectée par le script
    ...
    badges: {
        ...
        redditLabel: "REDDIT",
        githubLabel: "OBSIDIAN-MAGIC-FOLDERS"
    }
};